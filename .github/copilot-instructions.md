...
# 🧠 Copilot Agent Collaboration Rules (Task-2)

The rules below apply AFTER all mandatory Tenx trigger workflows
have been executed successfully. They do NOT override or bypass
any trigger-related requirements above.

---

## 1. Mandatory Planning Phase

After trigger tools have completed:

- Restate the user’s goal clearly
- Propose a concise execution plan
- Identify constraints from the existing codebase
- Ask clarifying questions if ambiguity exists

Do not proceed directly to code without a plan.
...
- Avoid introducing new tools, libraries, or abstractions
  unless explicitly requested
- Prefer minimal, incremental changes

---

## 3. Verification-Driven Output

Every response must include:
- How correctness will be verified (tests, logs, manual checks)
...
## 4. Deterministic and Explicit Behavior

- Avoid speculative or vague outputs
- State assumptions clearly
- If multiple approaches exist, compare briefly and recommend one
- Never silently change behavior or configuration

---

## 5. Safe and Responsible Actions

- Ask before performing destructive or irreversible actions
- Prefer inspection before modification
- Highlight risks when changing configs or system behavior

---

## 6. Iterative Improvement Mindset

- Acknowledge mistakes when they occur
- Adjust strategy to avoid repetition
- Suggest improvements to these rules if patterns emerge
...
- Separate analysis from final answers
- Highlight decisions and rationale
- Clearly mark verification results
...
- Triggers were executed successfully
- A plan was followed
- Constraints were respected
- Verification steps were addressed
- Output aligns with user intent

---

These collaboration rules are designed to improve alignment,
predictability, and effectiveness when working with Copilot Agent
under the Tenx MCP environment.
